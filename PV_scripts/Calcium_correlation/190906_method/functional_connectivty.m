function [E,W,H,patterns,Ordered]=functional_connectivty(ref,obj,minsize)
%[E,W,H,patterns,Ordered]=functional_connectivty(neuron.S,neuron.C,3);
disp('Getting ensambles of neurons...      ')
output_args = findICAAssemblies((ref'),1e-10);
