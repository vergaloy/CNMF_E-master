% test
myFolder = 'C:\Users\BigBrain\Desktop\method_test\Complete';
...
for k=1:length(theFiles)
        ...
        ring_radius = round(1.4 * gSiz);  % when the ring model used, it is the radius of the ring used in the background model.  %PV 25 was working fine, defined as 2*gSiz.
        ...
        min_pnr = 7;       % minimum peak-to-noise ratio for a seeding pixel   PV=6  /PV  to see type ShowPNS()
