...
[~,HM,Z,L,clus]=linkage_thr(a','plotme',0,'remove_0s',0,'Cdist','cosine','Cmethod','average');
plot_cluster_heatmap_means(HM,Z,L,clus);

[clut,HM2,Z2,L2,~]=linkage_thr(a,'plotme',1,'remove_0s',0,'Cdist','cosine','Cmethod','average');
...
figure;plot_cluster_heatmap2D(a,Z,L,clus,Z2,L2,clus1)
