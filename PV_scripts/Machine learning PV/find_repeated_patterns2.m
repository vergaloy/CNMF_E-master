...
S=get_distance_patterns_in(Wall);
Rt=linkage(S,Cmethod);
%   t=(1:65)';t=[t,t,t,t,t,t,t,t,t];t=t.*(1:9);


sim=10000;
parfor s=1:sim
    ranper=datasample(1:size(Wall{1, 1},1),size(Wall{1, 1},1));
    temp=get_distance_patterns_in(Wall,ranper);
...
function S=get_distance_patterns_in(Wall,ranper)
if (~exist('ranper','var'))
