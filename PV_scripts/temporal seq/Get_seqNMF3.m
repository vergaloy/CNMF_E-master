function [W,H,indSort]=Get_seqNMF3(C,exclud,po,plotme)
% [W,H,indsort]=Get_seqNMF3(C,[1,2,4,5,6,7,8,9],0.99,1);
...
[W0,H0]=NMF(X,k);
 ...
 [W,H] = seqNMF(X,'K',k_new, 'L', L,'lambda', lambda,'maxiter',100,'showplot',0,'lambdaOrthoW',1,'W_init',W0,'H_init',H0);
