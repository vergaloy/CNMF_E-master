...
nk = 0;             % detrending the slow fluctuation. usually 1 is fine (no detrending)  
...
merge_thr_spatial = [0.5, 0.00001, -inf];  % merge components with highly correlated spatial shapes (corr=0.8) and small temporal correlations (corr=0.1)
...
bd = 12;             % number of rows/columns to be ignored in the boundary (mainly for motion corrected data)
