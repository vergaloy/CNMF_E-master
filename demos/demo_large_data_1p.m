...
function demo_large_data_1p(name)
...
nk = 30;             % detrending the slow fluctuation. usually 1 is fine (no detrending)  PV 30 was working fine
...
%avi_filename = neuron.show_demixed_video(save_demixed, 1, [25192 26147], amp_ac, range_ac, range_Y, multi_factor);
