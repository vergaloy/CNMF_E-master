...
merge_thr = [0.8, 0.1, -inf];     % thresholds for merging neurons; [spatial overlap ratio, temporal correlation of calcium traces, spike correlation]
dmin = 1;
...
patch_par = [70,70]*1; %1;  % divide the optical field into m X n patches and do initialization patch by patch. It can be used when the data is too large 
...
neuron.options.nk = 30;  % number of knots for detrending 
...
neuron.orderROIs('snr');  % you can also use {'snr', 'mean', 'decay_time'} 
