...
% -------------------------      SPATIAL      -------------------------  %
gSig = 17;           % pixel, gaussian width of a gaussian kernel for filtering the data. 0 means no filtering
gSiz = 71;          % pixel, neuron diameter
...
ring_radius = 350;  % when the ring model used, it is the radius of the ring used in the background model.
